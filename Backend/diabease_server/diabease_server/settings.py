"""
Django settings for diabease_server project.
...
SECRET_KEY = 'django-insecure-+b#c7=cfe%p!p=4q=9ws2goq+8u-tqla65nm#a=v1ns=wq0j5s'
...
ROOT_URLCONF = 'diabease_server.urls'
